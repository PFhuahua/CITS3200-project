...
def match_result(Queries, ResInfo, max_retries=3, delay=2):
    ...
    model = genai.GenerativeModel(
        model_name="gemini-2.5-pro",
        system_instruction=(
        "You are a library search result matching system. You will be given a list of query strings and a dictionary with the library name as key and a list of search results as values."
